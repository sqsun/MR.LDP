...
// [[Rcpp::export]]
Rcpp::List MRLDP_RealVb(arma::ivec bp, arma::ivec chr, arma::uvec avbIndex, std::string block_file,
...
// [[Rcpp::export]]
Rcpp::List MRLDP_RealPXvb(arma::ivec bp, arma::ivec chr, arma::uvec avbIndex, std::string block_file,
                  std::string stringname3,
                  arma::vec bh1, arma::vec bh2, arma::vec se1, arma::vec se2,
                  arma::vec &gamma, arma::vec &alpha, double &beta0, double &sgga2, double &sgal2,
                  int coreNum, double lam, const int&constr, const double &epsStopLogLik, const int& maxIter, const int& model){
...
// [[Rcpp::export]]
Rcpp::List MRLDP_RealParPXvb(arma::ivec bp, arma::ivec chr, arma::uvec avbIndex, std::string block_file,
                    std::string stringname3,
                    arma::vec bh1, arma::vec bh2, arma::vec se1, arma::vec se2,
                    arma::vec &gamma, arma::vec &alpha, double &beta0, double &sgga2, double &sgal2,
                    int coreNum, double lam, const int&constr, const double &epsStopLogLik, const int& maxIter, const int& model){
...
// [[Rcpp::export]]
Rcpp::List MRLDP_RealVBMg(arma::ivec bp, arma::ivec chr, arma::uvec avbIndex, std::string block_file,
                    std::string stringname3,
                    arma::vec bh1, arma::vec bh2, arma::vec se1, arma::vec se2,
...
// [[Rcpp::export]]
Rcpp::List MRLDP_RealMggibbs(arma::ivec bp, arma::ivec chr, arma::uvec avbIndex, std::string block_file,
                    std::string stringname3,
                    arma::vec bh1, arma::vec bh2, arma::vec se1, arma::vec se2,
                    arma::vec &gamma, double &beta0, double &sgga2, double sgal2,
...
// [[Rcpp::export]]
Rcpp::List MRLDP_RealGibbspar(arma::ivec bp, arma::ivec chr, arma::uvec avbIndex, std::string block_file,
                        std::string stringname3,
                        arma::vec bh1, arma::vec bh2, arma::vec se1, arma::vec se2,
                        arma::vec &gamma, arma::vec &alpha, double &beta0, double &sgga2, double &sgal2,
